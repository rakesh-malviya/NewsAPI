var ChatBot = function () {
    ...
    return {
        ...
        addTree: function addTree(text, origin) {
            if (text == undefined) {
                return;
            }
            if (text == '') {
			...
			var t = document.createTextNode("Draw Tree");       // Create a text node
            ...
            var entryDiv = $('<div class="chatBotChatEntry ' + origin + '"></div>');            
            entryDiv.html('<span class="origin">' + (origin == 'bot' ? botName : humanName) + '</span>');
            entryDiv.append(btn)
        ...
        addMore: function addMore(text, origin) {
            if (text == undefined) {
                return;
            }
            if (text == '') {
            ...
            var btn = document.createElement("BUTTON");        // Create a <button> element
			var t = document.createTextNode("More info !!!");       // Create a text node
			btn.appendChild(t);                                // Append the text to <button>
			btn.addEventListener ("click", function() {
  				var newWin = window.open();
